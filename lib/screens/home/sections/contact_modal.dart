      ...
      () => Stack(
        children: [
          Container(
            margin: isSP
                ? EdgeInsets.zero
                : EdgeInsets.symmetric(horizontal: (size.width - 600) / 2),
                        ...
                        children: [
                          Flexible(
                            ...
                            child: ContactTextField(
                              ...
                              helper: 'Your Name',
                              controller:
                                  _contactController.getNameController(),
                            ),
                          ),
                          SizedBox(width: 24),
                          Flexible(
                            ...
                            child: ContactTextField(
                              ...
                              helper: 'Your Email',
                              controller:
                                  _contactController.getEmailController(),
                            ),
                          )
                        ],
                      ),
                      ...
                      Align(
                        ...
                        child: ActionButton(
                          ...
                          padding: EdgeInsets.only(
                              left: 24, right: 20, top: 16, bottom: 16),
                          onPressed: () {
